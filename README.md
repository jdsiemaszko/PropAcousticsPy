...
4) PotentialInteraction - analytical model for computing propeller and cylinder surface loadings based on Vella et al. 2026, Wu et al. 2022. Also includes conformal mapping implementation for hypotrochoidal and Joukowsky transforms, as to allow for noise prediction over polygonal and airfoil strut shapes.
